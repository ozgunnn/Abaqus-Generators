...
dic = {
     ...
     "shape": ['Circular', 'Circular', 'Circular', 'Circular','Circular','Rect','Rect','Rect','Rect'],
      "ez,t":   [11.1, 18.8, 26.5, 22.2, 36.2 ,8.9  ,2.8 ,6.9 ,11.9],
      "ey,t":   [5.7 , 10.4, 2.5 ,  5.2, 0.2  ,2.8  ,1.6 ,3.5 ,11.5],
      "ez,b":   [1.1 , 34.5, 33.5, 34.5, 36.8 , 12.0,5.5 ,1.8 ,14.2],
      "ey,b":   [0.9 , 6.3 , 2.5 , 0.5 , 1.8  ,7.1  ,1.8 ,1.4 ,10.8],
