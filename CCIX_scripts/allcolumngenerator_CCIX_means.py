...
name='B1_5m'
fs=538.0 #rebaryield x1.077 for mean
...
hc=400.0 #concrete depth (if rectangle)
...
fy=529.0 #profileyield x1.20 for mean
#
...
ec1=0.001*min(0.7*fcm**(1.0/3),2.8)
ecu1=0.001*min(3.5,2.8+14*((1-(fcm)/float(108))**4))
Ecm=9500*(fcm+8)**(1.0/3)
conc_denst=2.5e-9
conc_poisson=0.2
...
column_model.materials['mat_rebar'].Plastic(table=((fs,0),(1.08*fs,0.08*fs/(Esteel_rebar/100)),))
